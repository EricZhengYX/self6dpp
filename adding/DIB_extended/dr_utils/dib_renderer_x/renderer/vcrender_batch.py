...
class VCRenderBatch(nn.Module):
    ...
    def forward(self, points, cameras, colors):
        ...
        # return None, None, None, cameras[0]  # fake loss OK!!!
        ...
        for i in range(b):
            ...
            # return None, None, None, color_1xfx12.view((2, 1, -1))  # OK, OK, OK, not required grad
        ...
        # return None, None, None, normalz_1xfx1_list  # OK, OK, OK, not required grad
        ...
        # DO NOT USE imfeat_list[x][:, :, :, 3] CALCULATE LOSS!!!
        # return None, None, None, torch.cat((imfeat_list[0][:, :, :, 3], imfeat_list[1][:, :, :, 3]), dim=0)  # fake loss NOT OK
        ...
        hardmask = imfeat[:, :, :, 3:]  # (b,H,W,1) mask  # DO NOT USE IT FOR BP!!! FCK!!!
        if False:
            import cv2
        ...
        _sum_imrender = imrender.sum(dim=3)
        hardmask_good = (_sum_imrender != torch.zeros_like(_sum_imrender, requires_grad=True)).float()  # [b,H,W]
        hardmask_good.requires_grad = True  # haishi buxing
        # return imrender, improb_bxhxwx1, normal1_1xfx3_list, hardmask  # FOR BP: OK, OK, NOT USED, NOT OK
        return imrender, improb_bxhxwx1, normal1_1xfx3_list, hardmask_good
