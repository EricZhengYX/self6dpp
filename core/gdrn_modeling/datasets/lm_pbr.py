...
class LM_PBR_Dataset:
    def __init__(self, data_cfg):
        ...
        self.norm_root = data_cfg.get("norm", osp.join(self.dataset_root, "norm"))
...
SPLITS_LM_PBR = dict(
    lm_pbr_13_train=dict(
        ...
        norm_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/lm/train_pbr/norm"),
        vf_full_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/lm/train_pbr/vf_full"),
        vf_visib_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/lm/train_pbr/vf_visib"),
    ...
    lmo_pbr_train=dict(
        ...
        norm_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/lmo/train_pbr/norm"),
        vf_full_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/lmo/train_pbr/vf_full"),
        vf_visib_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/lmo/train_pbr/vf_visib"),
        scale_to_meter=0.001,
        with_masks=True,  # (load masks but may not use it)
        with_depth=True,  # (load depth path here, but may not use it)
        height=480,
